...
public class CornStage0UsloviieUspieshnoghoPrimienieniiaKostnoiMukiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (Math.random() < 0.7) {
			world.setBlock(BlockPos.containing(x, y, z), Blocks.AIR.defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x, y, z), EndElemetnModBlocks.CORN_STAGE_1.get().defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x, y + 1, z), (blockStateWithEnum(EndElemetnModBlocks.CORN_STAGE_1.get().defaultBlockState(), "half", "upper")), 3);
		} else {
			world.setBlock(BlockPos.containing(x, y, z), Blocks.AIR.defaultBlockState(), 3);
