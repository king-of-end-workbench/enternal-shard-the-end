...
public class SnarelingEntity extends EnderMan implements RangedAttackMob {

	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SnarelingEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "snareling_8hp");
	...
	public void performRangedAttack(LivingEntity target, float velocity) {
		SnarelingGlobEntity.shoot(this, target);
	}
	...
	public static void init() {
		SpawnPlacements.register(EndElemetnModEntities.SNARELING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
