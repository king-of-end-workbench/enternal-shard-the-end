...
public class SnarelingGlobEntity extends AbstractArrow implements ItemSupplier {
	...
	public SnarelingGlobEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(EndElemetnModEntities.SNARELING_GLOB.get(), world);
	}
	...
	public static SnarelingGlobEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SnarelingGlobEntity entityarrow = new SnarelingGlobEntity(EndElemetnModEntities.SNARELING_GLOB.get(), entity, world);
	...
	public static SnarelingGlobEntity shoot(LivingEntity entity, LivingEntity target) {
		SnarelingGlobEntity entityarrow = new SnarelingGlobEntity(EndElemetnModEntities.SNARELING_GLOB.get(), entity, entity.level());
