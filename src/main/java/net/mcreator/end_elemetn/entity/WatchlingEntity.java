...
public class WatchlingEntity extends EnderMan {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "watchling_8hp");
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EndElemetnModEntities.WATCHLING.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
