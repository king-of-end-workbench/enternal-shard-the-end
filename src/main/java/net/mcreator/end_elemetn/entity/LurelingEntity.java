...
public class LurelingEntity extends EnderMan {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "lureling_8hp");
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EndElemetnModEntities.LURELING.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
