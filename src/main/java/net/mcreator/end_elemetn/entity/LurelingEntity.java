...
import net.mcreator.end_elemetn.procedures.LurelureProcedure;
import net.mcreator.end_elemetn.procedures.LurelingPriStolknovieniiIghrokaSSushchnostiuProcedure;
...
public class LurelingEntity extends EnderMan {

	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(LurelingEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "lureling_8hp");
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			if (this.animationState0.isStarted()) {
				...
				if (elapsedSeconds >= lurelingAnimation.lureling_idle.lengthInSeconds()) {
					if (!lurelingAnimation.lureling_idle.looping())
						this.animationState0.stop();
					else
						this.animationState0.start(this.tickCount);
				}
	...
	public void baseTick() {
		super.baseTick();
		LurelureProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public void playerTouch(Player sourceentity) {
		super.playerTouch(sourceentity);
		LurelingPriStolknovieniiIghrokaSSushchnostiuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	public static void init() {
		SpawnPlacements.register(EndElemetnModEntities.LURELING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
