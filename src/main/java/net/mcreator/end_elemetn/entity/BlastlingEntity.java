...
import net.mcreator.end_elemetn.procedures.BlastlingPriObnovlieniiTikaSushchnostiProcedure;
...
public class BlastlingEntity extends EnderMan implements RangedAttackMob {

	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BlastlingEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(BlastlingEntity.class, EntityDataSerializers.INT);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public BlastlingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EndElemetnModEntities.BLASTLING.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, BlastlingEntity.class, (float) 3, 1, 1.2));
	...
	public void performRangedAttack(LivingEntity target, float velocity) {
		...
		BlastlingBulletEntity.shoot(this, target);
