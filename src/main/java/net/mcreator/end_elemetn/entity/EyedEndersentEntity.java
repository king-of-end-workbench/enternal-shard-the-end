...
public class EyedEndersentEntity extends EnderMan {

	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EyedEndersentEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(EyedEndersentEntity.class, EntityDataSerializers.INT);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();
	public final AnimationState animationState3 = new AnimationState();

	public EyedEndersentEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EndElemetnModEntities.EYED_ENDERSENT.get(), world);
	}

	public EyedEndersentEntity(EntityType<EyedEndersentEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
