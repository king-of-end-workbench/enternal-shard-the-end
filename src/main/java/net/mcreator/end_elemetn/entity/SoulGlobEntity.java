...
public class SoulGlobEntity extends AbstractArrow implements ItemSupplier {
	...
	public SoulGlobEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(EndElemetnModEntities.SOUL_GLOB.get(), world);
	}
	...
	public static SoulGlobEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SoulGlobEntity entityarrow = new SoulGlobEntity(EndElemetnModEntities.SOUL_GLOB.get(), entity, world);
	...
	public static SoulGlobEntity shoot(LivingEntity entity, LivingEntity target) {
		SoulGlobEntity entityarrow = new SoulGlobEntity(EndElemetnModEntities.SOUL_GLOB.get(), entity, entity.level());
