...
public class SoulGlobEntity extends AbstractArrow implements ItemSupplier {
	...
	public SoulGlobEntity(EntityType<? extends SoulGlobEntity> type, Level world) {
		super(type, world);
	}
	...
	public SoulGlobEntity(EntityType<? extends SoulGlobEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static SoulGlobEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0f, 10, 0);
	}

	public static SoulGlobEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 0f, 10, 0);
	}

	public static SoulGlobEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SoulGlobEntity entityarrow = new SoulGlobEntity(EndElemetnModEntities.SOUL_GLOB.get(), entity, world, null);
	...
	public static SoulGlobEntity shoot(LivingEntity entity, LivingEntity target) {
		SoulGlobEntity entityarrow = new SoulGlobEntity(EndElemetnModEntities.SOUL_GLOB.get(), entity, entity.level(), null);
