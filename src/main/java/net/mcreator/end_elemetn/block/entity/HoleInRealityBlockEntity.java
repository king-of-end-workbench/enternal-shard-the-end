...
public class HoleInRealityBlockEntity extends TheEndPortalBlockEntity {
	public HoleInRealityBlockEntity(BlockPos pos, BlockState state) {
		super(EndElemetnModBlockEntities.HOLE_IN_REALITY.get(), pos, state);
	}
