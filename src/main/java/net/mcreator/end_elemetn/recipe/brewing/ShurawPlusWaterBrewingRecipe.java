...
@EventBusSubscriber
public class ShurawPlusWaterBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new ShurawPlusWaterBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), EndElemetnModPotions.SHUGARED_WATER);
		}
