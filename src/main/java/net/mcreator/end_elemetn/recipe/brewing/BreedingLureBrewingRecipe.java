package net.mcreator.end_elemetn.recipe.brewing;
...
public class BreedingLureBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new BreedingLureBrewingRecipe());
	}
	...
	public boolean isInput(ItemStack input) {
		...
		return (inputItem == Items.POTION || inputItem == Items.SPLASH_POTION || inputItem == Items.LINGERING_POTION) && optionalPotion.isPresent() && optionalPotion.get().is(Potions.NIGHT_VISION);
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), EndElemetnModPotions.HYPNOTIZED_POTION);
		}
