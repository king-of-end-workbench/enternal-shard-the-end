...
public class SnarelingGlobRenderer extends EntityRenderer<SnarelingGlobEntity> {
	...
	@Override
	public void render(SnarelingGlobEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(SnarelingGlobEntity entity) {
		return texture;
	}
}