...
public class HoleInRealityRenderer extends TheEndPortalRenderer<HoleInRealityBlockEntity> {
	...
	@Override
	public void render(HoleInRealityBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
		long gameTime = blockEntity.getLevel().getGameTime();
		BeaconRenderer.renderBeaconBeam(poseStack, bufferSource, BEAM_LOCATION, partialTick, 1.0F, gameTime, -128, 128, DyeColor.PURPLE.getTextureDiffuseColors(), 0.15F, 0.175F);
