...
public class Modelblastling_control<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("end_elemetn", "modelblastling_control"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(124, 34).addBox(-6.0F, -16.0F, -4.0F, 12.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 0.0F));
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(8, 33).addBox(-4.0F, -8.0F, -6.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(71, 60)
				.addBox(-4.0F, -11.0F, -6.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(12, 66).addBox(-4.5F, -10.0F, -6.0F, 9.0F, 12.0F, 8.0F, new CubeDeformation(0.75F)), PartPose.offset(0.0F, -12.0F, -1.0F));
