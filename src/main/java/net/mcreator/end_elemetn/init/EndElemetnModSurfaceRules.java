	...
	public static void init(ServerAboutToStartEvent event) {
		...
		if (hasEndBiomes) {
			if (chunkGenerator instanceof NoiseBasedChunkGenerator generator) {
				...
				registerSurfaceRules(ResourceLocation.parse("end_elemetn:end_wilds"), noiseGeneratorSettings, EndElemetnModBlocks.ENDWILD_GRASS.get().defaultBlockState(), EndElemetnModBlocks.END_MESHFADES_STONE.get().defaultBlockState());
				registerSurfaceRules(ResourceLocation.parse("end_elemetn:chorus_forest"), noiseGeneratorSettings, EndElemetnModBlocks.CHORUS_GRASS.get().defaultBlockState(), Blocks.END_STONE.defaultBlockState());
				registerSurfaceRules(ResourceLocation.parse("end_elemetn:inverted_forest"), noiseGeneratorSettings, Blocks.END_STONE.defaultBlockState(), Blocks.END_STONE.defaultBlockState());
				registerSurfaceRules(ResourceLocation.parse("end_elemetn:void_plains"), noiseGeneratorSettings, EndElemetnModBlocks.SHADOW_GRASS.get().defaultBlockState(), EndElemetnModBlocks.PILLARS_OF_SHADOW_WOOD.get().defaultBlockState());
				registerSurfaceRules(ResourceLocation.parse("end_elemetn:dracora_oasis"), noiseGeneratorSettings, EndElemetnModBlocks.DRACORA_GRASS.get().defaultBlockState(), Blocks.END_STONE.defaultBlockState());
			}
		}
	}
