...
public class Modelsnareling_control<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "snareling_control"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(69, 1)
						.addBox(-4.5F, -8.0F, -2.5F, 9.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(10, 5)
						.addBox(-4.5F, -9.0F, -3.0F, 9.0F, 9.0F, 5.0F, new CubeDeformation(0.75F)),
